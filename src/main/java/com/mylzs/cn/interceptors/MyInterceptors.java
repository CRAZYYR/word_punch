...
public class MyInterceptors  implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        ...
        if ((httpServletRequest.getRequestURI().indexOf("reAttend")>=0) ||(httpServletRequest.getRequestURI().indexOf("login")>=0) || (httpServletRequest.getRequestURI().indexOf("attend")>=0 ) || ( httpServletRequest.getRequestURI().indexOf("error")>=0)){
            return  true;
        }
